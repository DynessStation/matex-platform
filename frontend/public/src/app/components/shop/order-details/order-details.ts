import { Location, AsyncPipe, DatePipe, TitleCasePipe, UpperCasePipe } from '@angular/common';
...
export class OrderDetails {
  ...
  country$: Observable<CountryModel> = inject(Store).select(
    CountryState.country,
  ) as Observable<CountryModel>;
  state$: Observable<StatesModel> = inject(Store).select(
    StateState.state,
  ) as Observable<StatesModel>;
