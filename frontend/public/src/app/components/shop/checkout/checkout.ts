...
import { OrderDeliveryBlock } from './delivery-block/delivery-block';
import { PaymentBlock } from './payment-block/payment-block';
import { Button } from '../../../shared/components/button/button';
import { Loader } from '../../../shared/components/loader/loader';
import { LoginModal } from '../../../shared/components/modal/login-modal/login-modal';
...
import { CheckoutAction, PlaceOrder } from '../../../shared/store/action/order.action';
...
export class Checkout {
  ...
  accessToken$: Observable<string | null> = this.store.select(AuthState.accessToken);
  ...
  countries$: Observable<Select2Data> = this.store.select(CountryState.countries);
  coupon$: Observable<CouponModel> = this.store.select(CouponState.coupon);
