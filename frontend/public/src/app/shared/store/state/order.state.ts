...
export class OrderState {
  ...
  @Action(PlaceOrder)
  placeOrder(_ctx: StateContext<OrderStateModel>, _action: PlaceOrder) {
    // Place order Logic Here
  }

  @Action(RePayment)
  rePayment(_ctx: StateContext<OrderStateModel>, _action: RePayment) {
    // RePayment order Logic Here
  }
  ...
  downloadInvoice(_ctx: StateContext<OrderStateModel>, _action: DownloadInvoice) {
